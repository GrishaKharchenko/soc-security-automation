"""Настройка логирования (та же схема, что в IOC Analyzer — общий модуль
будет вынесен в ядро при объединении проектов в SOC Automation Toolkit).
...
def get_logger(name: str) -> logging.Logger:
    """Дочерний логгер модуля: ``log_analyzer.enrichment.virustotal``."""
    return logging.getLogger(f"log_analyzer.{name}")
