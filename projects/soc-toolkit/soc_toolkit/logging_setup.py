"""Настройка логирования единой оболочки.

Схема общая для всех инструментов набора — это и есть один из результатов
объединения: раньше каждый проект настраивал логирование сам.
...
def get_logger(name: str) -> logging.Logger:
    """Дочерний логгер модуля: ``soc_toolkit.enrichment.virustotal``."""
    return logging.getLogger(f"soc_toolkit.{name}")
